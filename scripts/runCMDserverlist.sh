...
########################################################
#VARIABLES
properDIR="/home/wasadmin/maintence/scripts/properties"
resultDir="/tmp/results"
outputFILE="resultrunCMDlog.txt"
mainServerList="/home/wasadmin/maintence/scripts/properties/DBB-server-list-PREPROD.txt"
...
#echo "rhdbbetlalvt1.mid.aib.pri " >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbetlomvt1.mid.aib.pri " >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbdbsalvt2.mid.aib.pri " >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbdbsomvt2.mid.aib.pri " >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbcxpgm3.mid.aib.pri " >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbcxpgm4.mid.aib.pri " >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbentalvt2.mid.aib.pri" >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbexpalvt2.mid.aib.pri" >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbpdsalvt2.mid.aib.pri" >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbentomvt2.mid.aib.pri" >> $properDIR/$PREPRODserverlistfile
#echo "rhdbbpdsomvt2.mid.aib.pri" >> $properDIR/$PREPRODserverlistfile
	cat /home/wasadmin/maintence/scripts/properties/DBB-server-list-PREPROD.txt |uniq
echo "servers in total:"
	cat /home/wasadmin/maintence/scripts/properties/DBB-server-list-PREPROD.txt |uniq |wc -l
echo "############################################"
...
for host in $(cat /home/wasadmin/maintence/scripts/properties/DBB-server-list-PREPROD.txt); 
	...
	ssh -q "$userID"@"$host" "$commandRUN" ; echo "==========================" ; done
echo "script done!"	
}
runCMD
fi
