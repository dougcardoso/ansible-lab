...
do
ssh -q wasadmin@$host "hostname -f; sudo chmod -R 0777 /tmp; sudo chmod -R 0755 /logs; sudo chmod -R 755 /opt/liberty/wlp; sudo chown -R wasadmin:wasusers /opt/liberty/wlp/ ; sudo chown -R root:root /etc/init.d/ ; sudo chmod -R 755 /etc/init.d/ ;exit -1" &
done
exit -1
