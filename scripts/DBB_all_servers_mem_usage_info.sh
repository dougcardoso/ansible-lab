...
do
ssh -q wasadmin@$host "hostname -i ; sudo mpstat ; echo "check Linux server GB memory:" ; sudo free -mg ; echo "vmstat memory details:" ; sudo vmstat -s; echo "check PID highest MEM usage:"; ps aux --sort -rss | head -n10  " ;
echo "=====================================" 
