...
touch $TEMPscript_path/DBB_INVENTARY_SERVER.log
chmod -R 755 $TEMPscript_path
truncate -s0 $TEMPscript_path/DBB_INVENTARY_SERVER.log
########################################################
...
do
ssh -q wasadmin@$host "hostname -f ; hostname -i ; echo "liberty:" ; ls /opt/liberty/wlp/usr/servers ; echo "services:" ;ls /etc/init.d/ | grep wlp" >> $TEMPscript_path/DBB_INVENTARY_SERVER.log
echo "=====================================" >> $TEMPscript_path/DBB_INVENTARY_SERVER.log
